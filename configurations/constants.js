...
let subscription_messages_direct = {
    ...
    QDfH: `Goonj Comedy Rs%price% mein subscribe kar di gaye hai. Service dekhne k liye https://goonj.pk or unsub k liye call 03401832782`,
    QDfI: `Goonj Comedy Rs%price% mein subscribe kar di gaye hai. Service dekhne k liye https://goonj.pk or unsub k liye call 03401832782`,
};
let message_after_repeated_succes_charge = {
...
let message_after_first_successful_charge = {
...
let message_on_weekly_to_daily_switch = {
...
module.exports = {
    ...
    subscription_messages_direct: subscription_messages_direct,
    message_after_repeated_succes_charge: message_after_repeated_succes_charge,
    message_after_first_successful_charge: message_after_first_successful_charge,
    message_on_weekly_to_daily_switch: message_on_weekly_to_daily_switch
}